...
tree = Node(100)
insert_bst(tree, Node(101))
insert_bst(tree, Node(98))
insert_bst(tree, Node(99))
insert_bst(tree, Node(102))
insert_bst(tree, Node(97))
insert_bst(tree, Node(103))
insert_bst(tree, Node(93))
min = max_bst(tree)
