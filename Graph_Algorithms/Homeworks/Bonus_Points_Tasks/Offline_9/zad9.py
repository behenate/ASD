...
której pole G[i][j] ma wartość równą długości krawędzi z wierzchołka i do wierzchołka j, lub −1 jeśli krawędzi nie ma (wszystkie długości są nieujemne). Proszę
zaimplementować funkcję:
min cycle(G)
która sprawdza czy G ma cykl i jeśli tak, to zwraca cykl o najmniejszej sumie
długości tworzących go krawędzi. Jeśli cyklu nie ma, funkcja powinna zwrócić
pustą listę. Jeśli cykl istnieje, to funkcja powinna zwrócić listę wierzchołków,
które tworzą ten cykl."""
