...
między wierzchołkami i oraz j, przy czym M[i][j] == 0 oznacza brak krawędzi między wierzchołkami. W macierzy nie ma wartości ujemnych. Funkcja powinna zwrócić listę krotek postaci:
